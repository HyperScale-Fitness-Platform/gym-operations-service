...
export class InitialSchema1786756749174 implements MigrationInterface {
    name = 'InitialSchema1786756749174'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "trainer_slots" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trainer_id" uuid NOT NULL, "start_time" TIMESTAMP WITH TIME ZONE NOT NULL, "end_time" TIMESTAMP WITH TIME ZONE NOT NULL, "status" character varying NOT NULL DEFAULT 'open', CONSTRAINT "PK_ec15a4ad07cad3671c7f60ceebd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "bookings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "customer_id" character varying NOT NULL, "class_session_id" uuid, "trainer_slot_id" uuid, "trainer_id" uuid, "type" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'confirmed', "source_type" character varying, "source_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bee6805982cc1e248e94ce94957" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8e21b7ae33e7b0673270de4146" ON "bookings" ("customer_id") `);
        await queryRunner.query(`CREATE TABLE "class_sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "class_id" uuid NOT NULL, "trainer_id" uuid NOT NULL, "start_time" TIMESTAMP WITH TIME ZONE NOT NULL, "end_time" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_dc034da48c6e0cf95c51f606c4e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "membership_freezes" ("id" SERIAL NOT NULL, "daysUsed" integer NOT NULL, "previousEndDate" TIMESTAMP NOT NULL, "isCancelled" boolean NOT NULL DEFAULT false, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "membership_id" integer, CONSTRAINT "PK_646d90c2567c3e5789e3bc0ae37" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."memberships_status_enum" AS ENUM('ACTIVE', 'FROZEN', 'EXPIRED')`);
        await queryRunner.query(`CREATE TABLE "memberships" ("id" SERIAL NOT NULL, "customerId" character varying NOT NULL, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, "status" "public"."memberships_status_enum" NOT NULL DEFAULT 'ACTIVE', "freezeDaysUsed" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "plan_id" integer, CONSTRAINT "PK_25d28bd932097a9e90495ede7b4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "trainer_profiles" ("id" uuid NOT NULL, "full_name" character varying NOT NULL, "bio" text, "gender" character varying, "photo_url" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_656359178126f4d2c367321339c" PRIMARY KEY ("id"))`);
